...
"""
    chatbot.py - A plugin for making a bot chat with users.
    Copyright (C) 2009 Petr Morávek
    Part of the code was taken from pavlix's Arabicus bot (CC-attribution license)
    Copyright (C) 2008 Pavel Šimerda (pavlix)
