...
class xep_0086(base.base_plugin):
	...
	def makeError(condition, cdata=None, errorType=None, text=None, customElem=None):
		...
		if errorType is None:
			...
			error = slef.xmpp.makeStanzaError(conditionElem, errorType, self.error_map[condition][1], text, customElem)
